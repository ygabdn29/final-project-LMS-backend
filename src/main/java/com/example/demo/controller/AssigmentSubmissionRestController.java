...
public class AssigmentSubmissionRestController {
  @Autowired
  ...
  public ResponseEntity<Object> submitAssignment(
    ...
    try {
      ...
      if (assignment == null || !assignment.getMaterial().getId().equals(materialId)) {
        return Utils.generateResponseEntity(HttpStatus.NOT_FOUND, "Assignment not found or does not belong to the specified material");
      }
